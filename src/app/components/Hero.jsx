...
export default function Hero() {
  ...
  return (
    <section
      className="relative min-h-[92vh] flex items-center pt-24 pb-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-emerald-50/30"
      aria-labelledby="hero-heading"
    >
      {/* Subtle background blobs */}
      <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-emerald-100/40 rounded-full blur-3xl -translate-y-1/4 translate-x-1/3 pointer-events-none" aria-hidden="true" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-50/60 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4 pointer-events-none" aria-hidden="true" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <div className="flex items-center gap-2 bg-white border border-slate-200 rounded-2xl p-1.5 shadow-sm shadow-slate-100 mb-4 focus-within:border-emerald-400 focus-within:shadow-emerald-100 focus-within:shadow-md transition-all duration-200">
              ...
              <button
                className="bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors duration-150 flex-shrink-0"
                aria-label="Search"
              >
                Search
              </button>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm rounded-xl px-6 py-3 transition-all duration-150 shadow-sm hover:shadow-md"
              >
                Hire a Freelancer
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-700 font-semibold text-sm rounded-xl px-6 py-3 border border-slate-200 transition-all duration-150"
              >
                Offer Your Skills
              </a>
            </div>
          ...
          <div className="relative hidden lg:block" aria-hidden="true">
            ...
            {/* Main profile card */}
            <div className="relative z-10 bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/60 p-6 max-w-sm mx-auto">
              <div className="flex items-start gap-4 mb-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-violet-400 to-indigo-500 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">SJ</div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-50">
                ...
                <button className="text-xs font-semibold bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-xl transition-colors">View Profile</button>
              </div>
            </div>

            {/* Floating stat cards */}
            <div className="absolute -left-6 top-1/3 bg-white rounded-xl border border-slate-100 shadow-lg shadow-slate-200/50 px-4 py-3 flex items-center gap-3">
            ...
            <div className="absolute -right-4 bottom-12 bg-white rounded-xl border border-slate-100 shadow-lg shadow-slate-200/50 px-4 py-3">
        ...
        <div className="mt-16 pt-10 border-t border-slate-100">
          <div className="grid grid-cols-3 gap-6 max-w-lg">
            {stats.map((s) => (
              <div key={s.label}>
                <p className="text-2xl sm:text-3xl font-bold text-slate-900" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>{s.value}</p>
