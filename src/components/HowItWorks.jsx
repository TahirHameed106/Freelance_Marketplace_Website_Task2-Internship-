...
const steps = [
  {
    ...
    title: "Post Your Project",
    description:
      "Describe what you need — skills required, budget, and timeline. It takes less than 5 minutes.",
  ...
  },
  {
    ...
    title: "Review Proposals",
    description:
      "Qualified freelancers submit tailored proposals within hours. Compare profiles, portfolios, and rates.",
  ...
  },
  {
    ...
    title: "Hire & Collaborate",
    description:
      "Hire with one click. Use our built-in workspace for messaging, milestones, and file sharing.",
  ...
  },
  {
    ...
    title: "Pay Securely",
    description:
      "Funds are held in escrow and released only when you approve the work. Zero risk.",
...
const reasons = [
  {
    ...
    desc: "Every freelancer goes through ID verification and skill assessment.",
    icon: <CheckCircleIcon className="w-5 h-5 text-emerald-500" />,
  },
  {
    title: "Escrow Protection",
    desc: "Your money stays safe until you approve the final delivery.",
    icon: <LockClosedIcon className="w-5 h-5 text-emerald-500" />,
  },
  {
    title: "No Upfront Fees",
    desc: "Free to post projects. Pay only when you hire.",
    icon: <CurrencyDollarIcon className="w-5 h-5 text-emerald-500" />,
  },
  {
    title: "24/7 Support",
    desc: "Our support team resolves any dispute within 24 hours.",
...
export default function HowItWorks() {
  return (
    <>
      ...
      <section
        id="how-it-works"
        className="py-20 bg-slate-50/60"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-14">
            <p className="text-xs font-semibold tracking-widest text-emerald-500 uppercase mb-2">
              Process
            </p>
          ...
          >
            ...
            <div
              className="hidden lg:block absolute top-8 left-[12.5%] right-[12.5%] h-px bg-slate-200"
              aria-hidden="true"
            />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-slate-400 text-base leading-relaxed">
                We built SkillBridge because hiring freelancers online shouldn't
                feel like a gamble. Every feature is designed around trust,
                quality, and speed.
              </p>
            </div>
            ...
            >
              {reasons.map((reason) => (
                <li
                  key={reason.title}
                  className="bg-slate-800 border border-slate-700 rounded-2xl p-5 hover:border-emerald-500 hover:bg-slate-800/80 transition-all duration-300"
                >
